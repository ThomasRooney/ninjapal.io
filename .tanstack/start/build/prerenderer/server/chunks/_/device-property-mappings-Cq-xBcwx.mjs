const DEVICE_PROPERTY_MAPPINGS = {
  // Signal & Connectivity
  ...
  // Cooking State
  GET_CookState: { columnName: "cook_state_raw", dataType: "text" },
  // JSON string
  GET_Cook_Mode: {
  ...
  GET_GrillState: { columnName: "grill_state_raw", dataType: "text" },
  // JSON string
  GET_ProbeState: { columnName: "probe_state_raw", dataType: "text" },
  // JSON string
  GET_CombinedState: { columnName: "combined_state_raw", dataType: "text" },
  // JSON string
  // Timers & Scheduling
  GET_Seconds_To_Off: {
...
export { DEVICE_PROPERTY_MAPPINGS };
//# sourceMappingURL=device-property-mappings-Cq-xBcwx.mjs.map
